...
|-------|-------|:-----:|:----:|:-----------:|:-------:|:---------:|
| 0 | `sharegrid-shared` protocol update | 3 | 0 | 0 | 0 | 3 |
| 1 | Inference Proxy rewrite | 3 | 0 | 0 | 0 | 3 |
| 2 | Session Manager rewrite | 4 | 0 | 0 | 0 | 4 |
| 3 | Unit tests | 3 | 0 | 0 | 0 | 3 |
| 4 | Integration tests | 2 | 0 | 0 | 0 | 2 |
| — | **Total** | **15** | **0** | **0** | **0** | **15** |

### Notes / blockers

*(None yet — Phase 2 implementation not started.)*
